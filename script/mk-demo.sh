...
case "$0" in
    *mk-demo*)
        ...
        (cd "$DIR/.."; tar cvfz "$DIR/../dist/dist/dirs.tgz" script deployment doc CMakeLists.txt README.md maintenance/db-init/sensor-info.* sensor/simulation/*.mp4 --exclude=doc/asset)
