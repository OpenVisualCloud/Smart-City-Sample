define(`SERVICE_INTERVAL_SMART_UPLOAD',`120')dnl
    ...
    defn(`OFFICE_NAME')_smart_upload:
        ...
        environment:
            QUERY: "uploaded=false and time>=now-eval(defn(`SERVICE_INTERVAL_SMART_UPLOAD')*1000) where objects.detection.bounding_box.x_max-objects.detection.bounding_box.x_min>0.01"
            ...
            CLOUDHOST: "http://cloud_storage:8080/api/upload"
